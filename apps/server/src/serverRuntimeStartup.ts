...
import * as ReviewReactor from "./orchestration/Services/ReviewReactor.ts";
...
>()("pivot-cli/serverRuntimeStartup") {}
...
export const make = (options?: StartupOptions) =>
  Effect.gen(function* () {
    ...
    const reviewReactor = yield* ReviewReactor.ReviewReactor;
    ...
    const startup = Effect.gen(function* () {
      ...
      yield* runStartupPhase(
        ...
        Effect.gen(function* () {
          ...
          yield* reviewReactor.start().pipe(Scope.provide(reactorScope));
        }),
      );
          ...
          if (serverConfig.startupPresentation === "headless") {
            ...
            if (serverConfig.mode !== "desktop") {
              yield* Effect.logInfo(
                "Authentication required. Open Pivot using the pairing URL.",
