...
const make = Effect.fn("desktop.environment.make")(function* (
  ...
  const userDataDirName = isDevelopment ? "pivot-dev" : "pivot";
  ...
  return DesktopEnvironment.of({
    ...
    appUserModelId: Option.getOrElse(config.appUserModelIdOverride, () =>
      isDevelopment ? "com.13kparkin.pivot.dev" : "com.13kparkin.pivot",
    ),
    linuxDesktopEntryName: isDevelopment ? "pivot-dev.desktop" : "pivot.desktop",
    linuxWmClass: isDevelopment ? "pivot-dev" : "pivot",
